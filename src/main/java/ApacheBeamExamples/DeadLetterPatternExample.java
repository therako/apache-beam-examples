...
public class DeadLetterPatternExample {
    public static void main(String args[]) {
        ...
        parseMsg
            ...
            .apply("WriteToBQ", BigQueryIO.writeTableRows().to(pipelineOptions.getBqTable()));
        ...
        parseMsg
            ...
            .apply("WriteErrorsToBQ", BigQueryIO.writeTableRows().to(pipelineOptions.getBqErrorsTable()));
        ...
        parseMsg
            ...
            .apply("CountErrors", Count.globally())
